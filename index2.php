      ...
      <tr>
        <td width="960" height="544" valign="middle" background="imagens/fundo.png"><table width="871" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="964" cellpadding="0" cellspacing="0" bgcolor="#00929F">
            <tr>
              <td width="498" height="38" align="right" valign="top"><iframe src="http://www.sigemsistemas.com.br/demonstrativo_kaic.htm" name="extrato" width="460" marginwidth="0" height="38" marginheight="0" align="top" scrolling="no" frameborder="0"></iframe>                 </td>
